...
A file named `mix.exs` was generated inside our new project and it's main responsibility is to configure our project. Let's take a look at it (comments removed):
