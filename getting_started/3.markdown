...
Elixir brings the concept of module attributes from Erlang. The canonical example for attributes is annotating that a module implements the OTP behavior called `gen_server`:
