...
Tags in ExUnit are used to annotate tests. Tags can be later used to filter tests, for example, you can avoid running external tests in your machine because they are slow and dependent on other services, while they can still be enabled in your build system.
