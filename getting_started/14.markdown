...
Process get much more interesting when we are able to send and receive messages.
...
This time the process failed and brought the parent process down as they are linked.
