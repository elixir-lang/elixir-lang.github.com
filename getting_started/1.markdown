...
Elixir by default provides many functions to work on these types:
...
At the end of the day, strings are nothing more than binaries. We can verify this using the `is_binary` function:
