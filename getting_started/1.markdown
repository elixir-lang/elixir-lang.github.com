...
Elixir v0.7.0 is required to run this tutorial and it may be available in some distributions:

* Homebrew for Mac OS X: `brew install elixir --head` (`--head` will install the latest stable, the formula currently points to v0.6.0)
