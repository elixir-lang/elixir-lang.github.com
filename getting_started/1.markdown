...
If you find any errors in the tutorial or in the website, [please report a bug or send a pull request to our issues tracker](https://github.com/elixir-lang/elixir-lang.github.com). If you suspect it is a language bug, [please let us know in the language issues tracker](https://github.com/elixir-lang/elixir/issues).
