...
Elixir provides a package file with its compiled source for every release. You can grab the latest in the downloads page:

https://github.com/elixir-lang/elixir/downloads
