...
Finally, named functions also support default arguments:
...
This finishes our short introduction to modules. In the next chapters, we will learn how to use functions for recursion, explore Elixir lexical directives that can be used for importing functions from other modules, as well as module attributes.
