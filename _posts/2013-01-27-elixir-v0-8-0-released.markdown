...
The example above contains a string with only two codepoints, [the codepoint ﬁ](https://www.fileformat.info/info/unicode/char/FB01/index.htm) and [the codepoint n](https://www.fileformat.info/info/unicode/char/006E/index.htm). Look how Elixir properly capitalizes the string, returning a new string made of three codepoints (all ascii letters).
