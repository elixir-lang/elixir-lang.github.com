...
Elixir v1.7 implements [EEP 48](https://www.erlang.org/eeps/eep-0048). EEP 48 aims to bring documentation interoperability across all languages running on the Erlang VM.
