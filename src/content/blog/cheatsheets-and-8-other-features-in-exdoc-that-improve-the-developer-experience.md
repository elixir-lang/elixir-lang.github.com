---
title: "Cheatsheets and 7 other ExDoc features that improve the developer experience"
...
## Seven features that show how ExDoc has improved developer experience over time
...
of ExDoc](/images/contents/exdoc-phoenix-original-design.jpg)

Here's what it looks like today:

![Screenshot of the Phoenix v1.6.15 documentation generated with current
ExDoc](/images/contents/exdoc-phoenix-current-design.png)
...
documentation for a function](/images/contents/exdoc-source-code-link.gif)
...
documentation](/images/contents/exdoc-ecto-guides.gif)
...
in the `Ecto.Repo` module](/images/contents/exdoc-ecto-grouped-functions.png)
...
documentation](/images/contents/exdoc-full-text-search.png)
...
up.](/images/contents/exdoc-search-autocomplete.gif)
...
versions.](/images/contents/exdoc-version-dropdown.gif)
...
ExDoc](/images/contents/exdoc-erlang-telemetry.png)
