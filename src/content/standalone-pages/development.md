...
Elixir also relies on a vibrant community to support its growth. The community is behind the meetups, events, learning resources, open source projects, and more. See the sidebar, the [Learning Resources](/learning/) and [the Hex Package Manager website](https://hex.pm/) for some examples and more information.
