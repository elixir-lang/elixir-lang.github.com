...
\path (client.180)+(-1em,0) node [left-title] {\rotatebox{90}{client}};
...
\end{verbatim}
  ...
  \path (immediate.180)+(-1em,0) node [left-title] {\rotatebox{90}{immediate}};
...
\end{verbatim}
  ...
  \path (callback.180)+(-1em,0) node [left-title] {\rotatebox{90}{callback}};
...
\path (return-value.180)+(-1em,0) node [left-title] {\rotatebox{90}{\^{}result = }};
...
\path (reason.180)+(-1em,0) node [left-title] {\rotatebox{90}{\^{}reason = }};
...
\end{verbatim}
  ...
  \path (return-value.180)+(-1em,0) node [left-title] {\rotatebox{90}{immediate}};
