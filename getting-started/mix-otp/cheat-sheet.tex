...
\path (result.south east)+(3em,0) node (reason) [immediate,anchor=south west,fill=yellow!35] {
...
\end{verbatim}
  ...
  \path (result.south east)+(3em,0) node (then-what) [immediate,anchor=south west,fill=yellow!35] {
